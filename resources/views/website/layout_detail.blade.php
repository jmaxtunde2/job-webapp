...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta name="description" content=" {!! Str::limit($emploi->description, 35) !!}">
    <meta name="keywords" content="{{$setting->meta_tags ?? ''}}">
    <!-- Open Graph data -->
    <meta property="og:title" content="Azerke.Job - Emploi: {{$emploi->title ?? ''}} " />
    <meta property="og:type" content="jobs" />
    <meta property="og:url" content="{{route('job_detail',['slug' => $emploi->slug])}}" />
    <meta property="og:description" content=" {!! Str::limit($emploi->description, 35) !!}" />
...
<script data-ad-client="ca-pub-6872340834547426" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
