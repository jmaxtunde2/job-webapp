            ...
            <br/><br/><br/><br/>
				<h2 class="title1" style="margin-left:30px;">Gestion des Pays </h2>
					<div class="form-grids row widget-shadow" style="margin-left:30px;margin-right:20px;" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form id="editPays" data-id="{{$pays->id}}"> 
								<div class="row"> 
									<div class="form-group col-md-6"> 
										<label for="name">Nom</label><br/>
										<input type="text" class="form-control" name="name" id="name" value="{{$pays->name}}" required placeholder="Nom du Pays">
									</div> 
								</div>
								
							    <button id="btn-editPays" type="submit" class="btn btn-success" style="background-color:#629aa9;"><i class="fa fa-refresh"></i> Editer</button> 
							</form> 
						</div>
					</div>
			</div>
