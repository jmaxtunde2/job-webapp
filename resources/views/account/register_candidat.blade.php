...
<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<h2 class="title1">Inscription Reservé aux Candidats</h2>
				<div class="sign-up-row widget-shadow">
					
				<form id="registercandidatAction">
					<div class="sign-u">
					...
					<div class="sign-u">
						<select class="form-control" id="exampleFormControlSelect1" name="sexe" required>
					...
					<div class="sign-u">
						...
						<div class="clearfix"> </div>
					<div class="sub_home">
							<input type="submit" id="registercandidatBtn"value="S'inscrire">
						<div class="clearfix"> </div>
					</div>
