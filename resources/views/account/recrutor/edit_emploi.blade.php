							...
							<form id="editEmploi" data-id="{{$job->id}}"> 
								...
								<div class="row"> 
									...
									<div class="form-group col-md-6"> 
										...
										<input type="date" class="form-control" name="end_date" id="end_date"  value="{{$job->end_date}}" placeholder="La date de cloture">
									</div> 
								</div>
								...
								<div class="row"> 
									...
									<div class="form-group col-md-6">
                                                ...
                                                <textarea required name="description" class="form-control" placeholder="Decrire le job..."
							    ...
							    <button id="btn-editEmploi" type="submit" class="btn btn-success" style="background-color:#629aa9;"><i class="fa fa-plus"></i> Modifier</button> 
							</form> 
						</div>
					</div>
			</div>
