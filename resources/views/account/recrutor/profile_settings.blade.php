						  ...
						  <div id="user-info" class="tab-pane fade in active">
							...
							<div class="box-body">
                                            ...
                                            <form id="editUserSetting" data-id="{{$user->id}}">
                                                ...
                                                <div class="form-group col-md-6">
											<label class="font-weight-semibold" for="image">Logo :</label>
											<input type="file" class="form-control-file" name="photo" id="photo" aria-describedby="fileHelp">
											<small id="fileHelp" class="form-text text-muted">SVP, ajoutez votre logo. La taille ne doit pas dépasser 2MB. </small>
                                            <div style="width: 50%">
												<img src="{{URL::asset('/dashboards/images/users/'.$user->photo)}}" style="display:block;" width="83px" height="auto" class="img-responsive" />
											</div>
