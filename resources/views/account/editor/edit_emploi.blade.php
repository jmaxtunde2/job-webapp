						...
						<form id="editEmploi" data-id="{{$job->id}}"> 
								...
								<div class="row"> 
									<div class="form-group col-md-6"> 
										...
										<input type="text" class="form-control" name="company_name" id="company_name" required placeholder="Le nom de l'entreprise" value="{{$job->company_name}}">
									</div> 
									<div class="form-group col-md-6"> 
								...
								<div class="form-row">
                                    <div class="form-group col-md-6">
                                                ...
                                                <textarea name="description" id="description" class=" form-control editor" value="{{$job->description}}" placeholder="Decrire le job..."
                                                  rows="15">
								...
								<div class="form-row">
                                    <div class="form-group col-md-6">
                                                ...
                                                <textarea  name="required_knowledge" id="required_knowledge" class=" form-control editor" value="{{$job->required_knowledge}}" placeholder="Decrire les Competences Requises..."
                                                  rows="15"></textarea>
                                                   <div class="invalid-feedback" id="err_answer"></div>
									</div>
									<div class="form-group col-md-6">
                                                ...
                                                <textarea  name="education_experience" id="education_experience" class=" form-control editor" value="{{$job->education_experience}}" placeholder="Decrire les Competences Requises..."
                                                  rows="15"></textarea>
                                                   <div class="invalid-feedback" id="err_answer"></div>
                                    </div>
								</div>
