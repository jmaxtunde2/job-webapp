							...
							<form method="POST" id="addCategoryForm"> 
								<div class="row"> 
									<div class="form-group col-md-6"> 
										...
										<input type="text" class="form-control" name="name" id="name" required placeholder="Nom de la Categorie">
									</div> 
								</div>
								
							    <button id="btn-addCategory" type="submit" class="btn btn-success" style="background-color:#629aa9;"><i class="fa fa-plus"></i> Ajouter</button> 
							</form> 
						</div>
					</div>
			</div>
