            ...
            <br/><br/><br/><br/>
				<h2 class="title1" style="margin-left:30px;">Gestion des Emplois </h2>
					<div class="form-grids row widget-shadow" style="margin-left:30px;margin-right:20px;" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form method="POST" id="addEmploiForm"> 
								<div class="row"> 
								...
								<div class="row"> 
								    <div class="form-group col-md-6"> 
										...
										<input type="text" class="form-control" name="company_name" id="company_name" required placeholder="Le nom de l'entreprise">
									</div> 
									<div class="form-group col-md-6"> 
								...
								<div class="row"> 
									...
									<div class="form-group col-md-6"> 
										...
										<input type="text" class="form-control" name="apply_link" id="apply_link" required placeholder="Entrez l'adresse du site web ou l'email">
									</div> 
								</div>
