				...
				<div class="row">
                                        ...
                                        <div class="col-md-8">
                                                <div class="card table-card">
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item"><strong>DOB: </strong><span>{{ $candidat->dob }}</span></li>
                                                        <li class="list-group-item"><strong>Github: </strong><span>{{ $candidat->github }}</span></li>
                                                        <li class="list-group-item"><strong>LinkedIn: </strong><span>{{ $candidat->linkedIn }}</span></li>
                        ...
                        <table class="table">
                            ...
                            @endforelse
                                                    ...
                                                    <br/>
                                                    <a href="{{route(''.$data["user_type"].'.updatecv')}}" class="btn btn-primary">Modifier CV</a> 
                                                    </div>
                                                </div>
                                        </div>
			</div>	
